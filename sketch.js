 ...
 function  preload(){
  ...
  function setup() {
    ...
    resetSprite = createSprite(200,300,50,50)
    resetSprite.visible = false
    resetSprite.scale = 0.5

    resetSprite.addImage("fixCar", fixCar)
  }
  ...
  function draw() {
    if(gameState === STORY){
      ...
      moneyGroup.setVisibleEach(true)
    ...
    moneyGroup.bounceOff(edges)
      ...
      if(score %3 === 0 && score != 0 && car === "notmove"){
        cop.x = cop.x + 200
        car = "move"
      }
...
fill("black")
textSize(25)
text("YOU LOSE: THE ROBBER GOT AWAY, FIX YOUR CAR AND GET BACK ON THE CHASE!!", 200, 200)
